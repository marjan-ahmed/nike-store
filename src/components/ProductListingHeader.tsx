...
async function getProductCount() {
    const data = await client.fetch(`count(*[_type == "product"])`);
    return data;
}

export default async function ProductListingHeader() {
    ...
    return (
        <div className='w-full font-semibold px-4 sm:px-12 mt-10 flex justify-between items-end'>
            ...
            <div className="flex gap-6">
                <DropdownMenu>
                    <DropdownMenuTrigger>
                        <div className='flex items-center gap-1'>Sort By <ChevronDown size={18} /></div>
                    </DropdownMenuTrigger>
                    <DropdownMenuContent>
