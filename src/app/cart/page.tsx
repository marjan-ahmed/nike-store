  ...
  return (
    <div className="container mx-auto px-4 py-12 max-w-6xl">
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <>
              {cartItems.map((item: CartItem) => (
                <div
                  ...
                  className="mb-6 flex flex-col sm:flex-row gap-4 pb-6 border-b"
                >
                  <div className="relative w-full sm:w-[161px] h-[161px] rounded-md overflow-hidden">
                    <Image
                      src={item.images[0]}
                      alt={item.name}
                      width={161}
        ...
        {/* Summary Section - Appears Only When Cart Has Items */}
        {cartItems.length > 0 && (
